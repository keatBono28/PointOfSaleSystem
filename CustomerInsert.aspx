<%@ Page Title="" Language="C#" MasterPageFile="~/MIS3200/MasterPagekb619814.master" AutoEventWireup="true" CodeFile="CustomerInsert.aspx.cs" Inherits="MIS3200_FPkb619814_Customer_CustomerInsert" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="Create New Customer" />
